"""auth-04: Отображение ошибки по невалидному телефону."""
import allure
import pytest
...
class TestAuth04:
    ...
    @allure.title("auth-04: Ошибка по невалидному телефону")
    ...
    def test_auth_04_invalid_phone_format(self, sign_in_page: SignInPage):
